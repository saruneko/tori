...
FocusScope {
    ...
    property string fontSize: Theming.ComponentUtils.style(editor, "fontSize", "medium")
    ...
    Flickable {
        ...
        TextEdit {
            ...
            font.capitalization: Theming.ComponentUtils.style(editor, "capitalization", Font.MixedCase)

            font.family: Theming.ComponentUtils.style(editor, "fontFamily", "Ubuntu")

            font.italic: Theming.ComponentUtils.style(editor, "italic", false)

            font.letterSpacing: Theming.ComponentUtils.style(editor, "letterSpacing", 0.0)

            font.pixelSize: FontUtils.sizeToPixels(fontSize)

            font.strikeout: Theming.ComponentUtils.style(editor, "strikeout", false)

            font.underline: Theming.ComponentUtils.style(editor, "underline", false)

            font.wordSpacing: Theming.ComponentUtils.style(editor, "wordSpacing", 0.0)
